...
md
  ...
  main.variable(observer("map")).define("map", ["d3","colombiaGeoJSON"], function(d3,colombiaGeoJSON)
{
  ...
  function numberG(d){
    return d && d.properties ? d.properties.NUM_GRUPS : null;
  }

  // Get province name length
  function nameLength(d){
    var n = Number(numberG(d));
    return n;
  }
  ...
  function mouseover(d){
    ...
    d3.select(this).style('fill', '#F2CD30');

    // Draw effects
    textArt(nameFn(d)+", "+ "Numero de grupos de investigación:" + " " +numberG(d));
  ...
  main.variable(observer("colombiaGeoJSON")).define("colombiaGeoJSON", ["d3"], function(d3){return(
d3.json("./ii.json")
)});
